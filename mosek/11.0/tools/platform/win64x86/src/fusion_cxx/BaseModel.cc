...
namespace mosek
{
  namespace fusion
  {
    ...
    MSKtask_t BaseModel::clonetask() {
      return _impl->clonetask();
    }
    ...
    MSKtask_t p_BaseModel::__mosek_2fusion_2BaseModel__clonetask() { return task->clone(); }
    MSKtask_t p_BaseModel::clonetask() { return __mosek_2fusion_2BaseModel__clonetask(); }
    ...
    void p_BaseModel::task_analyze_problem(int detail)
    {
      task->putparam("MSK_IPAR_LOG_ANA_PRO",detail);
      task->analyzeproblem(MSK_STREAM_LOG);
    }
